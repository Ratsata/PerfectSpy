        ...
        <div id="dashboard-header" class="tx-soft-background">
            <div class="uk-grid-collapse" uk-grid>
                <div class="uk-width-expand uk-padding-small">
                    ...
                    <div class="uk-display-inline-block uk-padding-small uk-padding-remove-bottom uk-padding-remove-top"
                         style="vertical-align: middle;">
                        <div class="uk-text-small">Perfect Spy &raquo;</div>
                        <h1 class="uk-header uk-margin-remove uk-text-bold">TORRE 1</h1>
